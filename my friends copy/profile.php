...
if (isset ($_GET['u'])){
   ...
   {
   	echo "<meta http-equiv= \"refresh\" content=\"0; url=http://localhost/my friends/index.php\">";
   exit();
   }
   }
 }
...
<div class = "postform">
	...
	<input type="submit" name="send" value="post" style="background-color: #DCE5EE; float: right; border: 1px solid #666; padding: 5px;" />
   </form>
</div>
...
$errorMsg="";
 if (isset($_POST['addfriend']))
 {
   ...
   else
   {
     ...
     $errorMsg = "your firend request has been sent ";
   }
 }
 else
 {
