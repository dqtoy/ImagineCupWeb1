...
<?php
    ...
    $msg_title = $msg_title;
      ...
      if (strlen($msg_body) > 150) {
        ...
        $msg_body = $msg_body;
    if (@$_POST['setopend_'.$id.'']){
      //update the private messages table 
      $setopend_query = mysql_query("UPDATE pvt_messages SET opened='yes' WHERE id='$id'") or die (mysql_error());
...
<input type ='submit' name='setopend_$id' value= \"i've read this\">
</form>
